...
movie = Movie.objects.all()
for m in movie:
print(Director.objects.get(id=m.director_id).name, m.genre, m.title, m.opening_date, m.running_time, m.screening)
```
...
movie = Movie.objects.all()
for m in movie:
  print(Director.objects.get(id=m.director_id).name, 
 Genre.objects.get(id=m.genre_id).title,m.title, m.opening_date, m.running_time,m.screening)
```
...
for m in movie:  print(Director.objects.get(id=m.director_id).name,Genre.objects.get(id=m.genre_id).title,m.title, m.opening_date, m.running_time,m.screening)
```
...
```python
movie = Movie.objects.order_by('opening_date')
print(Director.objects.get(id=m.director_id).name,Genre.objects.get(id=m.genre_id).title,m.title, m.opening_date, m.running_time,m.screening)
```
...
movie = Movie.objects.order_by('opening_date')
for m in movie:
  if Director.objects.get(id=m.director_id).name == '봉준호':
 print(Director.objects.get(id=m.director_id).name,Genre.objects.get(id=m.genre_id).title,m.title, m.opening_date, m.running_time,m.screening)
```
...
```python
movie = Movie.objects.all()[2:3]
for m in movie:
  if Director.objects.get(id=m.director_id).name == '봉준호': 			print(Director.objects.get(id=m.director_id).name,Genre.objects.get(id=m.genre_id).title,m.title, m.opening_date, m.running_time,m.screening)
```
...
```python
movie = Movie.objects.filter(genre_id=2, director_id=1).order_by('opening_date')
for m in movie:
 print(Director.objects.get(id=m.director_id).name,Genre.objects.get(id=m.genre_id).title,m.title, m.opening_date, m.running_time,m.screening)
```
...
```python
movie = Movie.objects.exclude(director_id=1).order_by('opening_date')
for m in movie:
 print(Director.objects.get(id=m.director_id).name,Genre.objects.get(id=m.genre_id).title,m.title, m.opening_date, m.running_time,m.screening)
```